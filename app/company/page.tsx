...
import { getCompany, loadCompanyFromDb, saveCompanyToDb, type Company } from '@/lib/storage';
...
export default function CompanyPage() {
  ...
  useEffect(() => {
    ...
    loadCompanyFromDb().then(setCompany).catch((e) => {
      console.warn(e);
    });
  }, []);
  ...
  async function onSave() {
    try {
      ...
      console.warn(e);
      alert('No s\'han pogut desar les dades a la BBDD. Revisa la connexió o la configuració del servidor.');
    }
  }
